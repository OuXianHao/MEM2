...
```
The generated result is a jsonl file containing the generated trajectories. An example generated by running our released 7B model over the q2 test dataset can be found under `examples`.
